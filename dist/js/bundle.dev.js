    ...
    var SingleSlideCarousel = function (_CarouselBase$Carouse) {
        ...
        _createClass(SingleSlideCarousel, [{
            ...
            value: function handleGoTo(options) {
                ...
                var that = this;
                var enterAnimationStatus = this.handleAnimationOverSlide(this.elements[newActiveIndex], options.enterAnimation, null);
                var leaveAnimationStatus = this.handleAnimationOverSlide(this.elements[oldActiveIndex], options.leaveAnimation, function () {
                ...
                var soraHandlerStatus = new Promise(function (resolve, reject) {
                    Promise.all([enterAnimationStatus.elementAnimationStatus, leaveAnimationStatus.elementAnimationStatus]).then(function (slidesAnimationStatus) {
            ...
            value: function handleAnimationOverSlide(element, animation, callBackOnClear) {
                var childrenStatus = {};
            ...
            value: function handleAnimationOverElement(elementAnimation, callBackOnClear) {
                                ...
                                return function () {
                                    ...
                                    if (index < styles.length - 1) {
                                        ...
                                        var clearFunction = function clearFunction() {
                                            ...
                                            if (callBackOnClear != null) callBackOnClear();
                                            resolve({
                                                element: element,
                                                styles: styles
                                            });
